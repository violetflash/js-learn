...
document.querySelector('.weather__city').onchange = () => {
    let city = document.querySelector(".weather__city").value;
    fetch(`http://api.openweathermap.org/data/2.5/weather?id=${city}&cnt=16&appid=ef055dc2a3ce7e62285e867ad3dd0302`)
        .then(function (resp) {
            return resp.json()
        })
        .then(function (data) {
