...
function f5(){
    ...
    output.innerHTML = (num < 0) ? "m" : (num == 0) ? 0 : 1;
}
...
function f6(){
    ...
    output.innerHTML = (num % 2 == 0) ? "even" : "odd";
}
...
function f9(){
    ...
    output.innerHTML = ( num >= 1 && num <= 32) ? 1 :
        ( num >= 33 && num <= 43 ) ? 2 :
            ( num >= 44 && num <= 64 ) ? 3 : 0
}
