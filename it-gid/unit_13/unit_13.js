...
function f4() {
    out = "";
    for (const a4Key in a4) {
        out += `${a4Key} ${a4[a4Key]} <br>`;
    }
    return out;
}
...
function f6() {
    ...
    a6[key] = document.querySelector('.i-62').value;
    f5(a6,".out-6");
}
...
function f7() {
    ...
    document.querySelector(".out-7").innerHTML = ( a7[key] !== undefined ) ? 1 : 0;
}
...
function f8() {
    ...
    document.querySelector(".out-8").innerHTML = ( a8[key] !== undefined ) ? a8[key] : 0;
}
...
function f12() {
    ...
    for (const a12Key in a12) {
        if ( key == a12[a12Key] ) delete a12[a12Key];
    }
    f5(a12, ".out-12");
}
...
function f15() {
    ...
    for (const a15Key in a15) {
        for (let i = 0; i < a15[a15Key].length; i++) {
            out += `${a15[a15Key][i]} `;
        }
...
function f17() {
    let out = "";
    for (const a17Key in a17) {
        if ( a17[a17Key].age > 30 ) {
            out += `${a17[a17Key].name} `;
        }
    }
...
function f18() {
    ...
    for (const a18Key in a18) {
        if ( key == a18Key ) {
            for (let i = 0; i < a18[a18Key].length; i++) {
                out += `${a18[a18Key][i]} `;
            }
        }
    }
...
function f19() {
    let out = "";
    let key = document.querySelector('.i-19').value;
    for (const a19Key in a19) {
        for (let i = 0; i < a19[a19Key].length; i++) {
            if ( key.toLowerCase() === a19[a19Key][i].toLowerCase() ) {
                out = a19Key;
            }
        }
    }
...
function f20() {
    let out = "";
    for (const a20Key in a20) {
        for (let i = 0; i < a20[a20Key].length; i++) {
            if ( a20[a20Key][i][1] === 2 ) {
                out += `${a20[a20Key][i][0]} `;
            }
        }
