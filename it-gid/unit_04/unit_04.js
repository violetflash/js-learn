...
function f4() {
    ...
    document.querySelector(".out-4").innerHTML = checkbox.checked;
}
...
function f7() {
    ...
    document.querySelector(".out-72").innerHTML = ( (input.value).length >= 6 ) ? 1 : 0;
}
...
function f8() {
    ...
    document.querySelector(".out-8").innerHTML += "<button type='button' class='b-81'>Кнопка</button>";
...
function f9() {
    ...
    document.querySelector('.out-9').innerHTML = ( checkbox.checked ) ? checkbox.value : 0;
}
...
function f10() {
    ...
    document.querySelector('.out-10').style.backgroundColor = input.value;
}
...
function f12() {
    ...
    document.querySelector('.out-12').innerHTML = input.value;
}
...
function f13() {
    ...
    document.querySelector('.out-13').innerHTML = input.value;
}
...
function f14() {
    let input = document.querySelector('.t-14');
    document.querySelector('.out-14').innerHTML = input.value;
}
